...
function WarehouseLogin() {
    ...
    // NOTE: the OTP "link account" flow is retired — the backend now links
    // the Google account to the warehouse record automatically during OAuth
    // (google_id is set server-side), so there is nothing to link manually.
    ...
    // (OTP link-account screen removed — flow retired; backend auto-links during OAuth.)
