...
export default function ReleaseUpdateModal() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/70 px-4 pb-4 backdrop-blur-sm sm:items-center sm:pb-0">
            <div className="w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 bg-[#0b1224] shadow-2xl">
                <div className="relative border-b border-white/10 bg-white/[0.03] px-6 py-5">
                    ...
                    <p className="mt-2 pr-8 text-sm font-medium leading-6 text-slate-300">
                        {release.subtitle}
                    </p>
                </div>
