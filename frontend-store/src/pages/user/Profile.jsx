...
function Profile() {
    ...
    const navigationItems = [
        ...
        { icon: FileText, label: 'Terms & Conditions', path: '/profile/terms', color: 'text-slate-700', bg: 'bg-slate-700/10' },
        { icon: Shield, label: 'Privacy Policy', path: '/profile/privacy', color: 'text-emerald-600', bg: 'bg-emerald-600/10' },
        ...
        { icon: Bug, label: 'Report a Bug', path: '/profile/bug-report', color: 'text-red-500', bg: 'bg-red-500/10' },
        { icon: AlertCircle, label: 'My Bug Reports', path: '/profile/my-bug-reports', color: 'text-rose-500', bg: 'bg-rose-500/10' },
        { 
            icon: Download, 
            label: 'Download App', 
            onClick: () => {
