        ...
        <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 relative z-10 border border-white/20">
                ...
                <div className="w-full mt-4 flex justify-center mb-6">
                    <a
                        href={oauthLoginUrl}
                        onClick={() => localStorage.setItem('is_admin_login_attempt', 'true')}
                        className="flex items-center justify-center gap-3 w-full border border-gray-300 rounded-xl py-3 px-4 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors bg-white shadow-sm"
                    >
            ...
            <div className="absolute bottom-4 text-slate-500 text-xs font-medium">
                JDLX Official Admin Panel • v1.0
            </div>
        </div>
    )
}
