...
function SearchBar() {
    ...
    return (
        <div ref={containerRef} className="relative flex-1 max-w-md mx-4 md:mx-10 group">
            <div className="relative flex items-center">
                ...
                <input
                    ...
                    className="w-full bg-gray-100/50 border border-gray-200/50 rounded-xl pl-10 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:bg-white transition-all shadow-inner"
                />
                {isLoading ? (
